...
void test_normal_pdf() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(normal_pdf(inputs[i], 0, 1), expected[i]);
    }
}
...
void test_normal_cdf() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(normal_cdf(inputs[i], 0, 1), expected[i]);
    }
}
...
void test_normal_ppf() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(normal_ppf(inputs[i], 0, 1), expected[i]);
    }
}
...
void test_students_t_pdf_one() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_pdf(inputs[i], 1), expected[i]);
    }
}
...
void test_students_t_pdf_two() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_pdf(inputs[i], 2), expected[i]);
    }
}
...
void test_students_t_pdf_thirty() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_pdf(inputs[i], 30), expected[i]);
    }
}
...
void test_students_t_cdf_one() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_cdf(inputs[i], 1), expected[i]);
    }
}
...
void test_students_t_cdf_two() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_cdf(inputs[i], 2), expected[i]);
    }
}
...
void test_students_t_cdf_thirty() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_cdf(inputs[i], 30), expected[i]);
    }
}
...
void test_students_t_ppf_one() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_ppf(inputs[i], 1), expected[i]);
    }
}
...
void test_students_t_ppf_two() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_ppf(inputs[i], 2), expected[i]);
    }
}
...
void test_students_t_ppf_thirty() {
    ...
    for (int i = 0; i < sizeof(inputs) / sizeof(double); i++) {
        assert_in_delta(students_t_ppf(inputs[i], 30), expected[i]);
    }
}
